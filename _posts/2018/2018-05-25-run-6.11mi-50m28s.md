...
|:--------:|:----:|:----:|:------:|:----:|
|6.11mi|50m28s|8m15s/mi|![Strava iPhone App]({{ site.url }}/images/devices/strava.png)|Adidas Supernova Glide Boost Adidas Blue|

Sleeping outside and waking up to run with the deer before the kids take over.

![]({{ site.url }}/images/maps/2018/2018-05-25-run-6.11mi-50m28s.png)
